...
| `AWS_SECRET_ACCESS_KEY`  | ✅ Added — edusphere-deploy IAM user secret                                          |
| `TF_STATE_BUCKET`        | ✅ Added — `edusphere-tf-state-816069153839`                                         |
| `ACM_CERTIFICATE_ARN`    | ✅ Add — `arn:aws:acm:ap-south-1:816069153839:certificate/ba46e859-6426-4c4b-b799-f0b3e6791351` |
| `DB_PASSWORD`            | ❌ Add — Strong password min 16 chars e.g. `EduSphere@Mumbai2026!`                  |
